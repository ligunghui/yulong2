...
public class GoodsController {
    ...
    @RequiresPermissions("good_delete")
    ...
    public Result findAll() {
        List<ShoppingGoods> shoppingGoods = goodsService.findAll();
        return new Result(ResultCode.SUCCESS, shoppingGoods);
    }
