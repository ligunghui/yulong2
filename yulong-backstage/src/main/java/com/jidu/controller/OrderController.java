...
public class OrderController {
    ...
    @RequestMapping(value = "/findByStoreId/{storeId}/{pageNum}/{pageSize}", method = RequestMethod.GET)
    @ApiOperation(value = "查询订单")
    @ApiImplicitParams({
            @ApiImplicitParam(name="pageNum",value="商户id(平台传0)",required=true,paramType="path"),
